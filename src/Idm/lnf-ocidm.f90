...
module LnfOcInputModule
  use ConstantsModule, only: LENVARNAME
  use InputDefinitionModule, only: InputParamDefinitionType, &
                                   InputBlockDefinitionType
  private
  public lnf_oc_param_definitions
  public lnf_oc_aggregate_definitions
  public lnf_oc_block_definitions
  public LnfOcParamFoundType
  public lnf_oc_multi_package
  public lnf_oc_subpackages

  type LnfOcParamFoundType
    ...
    logical :: steps = .false.
  end type LnfOcParamFoundType

  logical :: lnf_oc_multi_package = .false.
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budfilerec = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budget = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_fileout = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budgetfile = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budcsvfilerec = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budgetcsv = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_budgetcsvfile = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_headfilerec = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_head = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_headfile = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_headprintrec = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_print_format = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_formatrecord = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_columns = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_width = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_digits = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_format = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_saverecord = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_save = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_printrecord = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_print = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_rtype = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_ocsetting = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_all = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_first = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_last = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_frequency = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    lnfoc_steps = InputParamDefinitionType &
    ( &
    'LNF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
