...
Unlike the single-fluid case, the vertical flow here IS buoyancy-gated: each
fluid moves freely in its buoyant direction and is gated in the other by the
