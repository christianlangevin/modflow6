...
SWI6-SWI6 & Exchange between a freshwater Groundwater Flow Model and a saltwater Groundwater Flow Model that both use the Seawater Intrusion (SWI) Package.  Input for this file is described in a dedicated section in this guide. \\
\hline
\end{tabular*}
\label{table:exgtype}
\end{center}
